...
namespace WanderersDiary.CharacterManagement.Static
{
    public static class ArmorCollection
    {
        ...
        {
            Name = new LocalizedString { EN = "Padded armor", RU = "Стёганная броня" }, Type = EArmorType.Light,
            Price = 5,
        ...
        {
            Name = new LocalizedString { EN = "Leather armor", RU = "Кожаная броня" }, Type = EArmorType.Light,
            Price = 10,
            BaseAC = 11, HaveDexterityModifier = true, MaxDexterityBonus = null, 
            StrenghtRequirement = null,
        ...
        {
            Name = new LocalizedString { EN = "Studded leather armor", RU = "Клёпанная кожаная броня" }, Type = EArmorType.Light,
            Price = 45,
        ...
        {
            Name = new LocalizedString { EN = "Hide armor", RU = "Броня из шкур" }, Type = EArmorType.Medium,
            Price = 10,
        ...
        {
            Name = new LocalizedString { EN = "Chain shirt", RU = "Кольчужная рубаха" }, Type = EArmorType.Medium,
            Price = 50,
        ...
        {
            Name = new LocalizedString { EN = "Chain shirt", RU = "Чешуйчатая броня" }, Type = EArmorType.Medium,
            Price = 50,
        ...
        {
            Name = new LocalizedString { EN = "Breastplate", RU = "Кираса" }, Type = EArmorType.Medium,
            Price = 400,
            BaseAC = 14, HaveDexterityModifier = true, MaxDexterityBonus = 2,
            StrenghtRequirement = null,
            HaveStealthDisadvantage = false,
        ...
        {
            Name = new LocalizedString { EN = "Half plate", RU = "Полулаты" }, Type = EArmorType.Medium,
            Price = 750,
        ...
        {
            Name = new LocalizedString { EN = "Ring mail", RU = "Колечная броня" }, Type = EArmorType.Heavy,
            Price = 30,
        ...
        {
            Name = new LocalizedString { EN = "Chain mail", RU = "Кольчуга" }, Type = EArmorType.Heavy,
            Price = 75,
        ...
        {
            Name = new LocalizedString { EN = "Splint armor", RU = "Наборная броня" }, Type = EArmorType.Heavy,
            Price = 200,
        ...
        {
            Name = new LocalizedString { EN = "Plate armor", RU = "Латы" }, Type = EArmorType.Heavy,
            Price = 1500,
        ...
        {
            Name = new LocalizedString { EN = "Shield", RU = "Щит" }, Type = EArmorType.Shield,
            Price = 10,
